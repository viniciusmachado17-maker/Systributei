                ...
                <div className="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 overflow-hidden">
                    ...
                    <div className="bg-brand-600 p-8 md:p-12 text-white relative">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-brand-100 font-medium italic">TributeiClass (https://tributeiclass.com.br)</p>
                            <p className="text-brand-100 font-medium mt-2">Última atualização: 15/02/2026</p>
                        </div>
                    </div>
                    ...
                    <div className="p-8 md:p-12">
                        <div className="prose prose-slate max-w-none">
                            ...
                            <section className="mb-10">
                                ...
                                <ul className="list-none space-y-3 text-slate-600 text-sm leading-relaxed">
                            ...
                            <section className="mb-10">
                                ...
                                <p className="text-slate-600 text-sm font-bold mt-2 italic">Contato de privacidade: suporte@tributeiclass.com.br</p>
                            </section>
