...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Click 'Entrar na Plataforma' button to submit login form
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Administrador Tributei').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=Consulta de Produtos').first).to_be_visible(timeout=30000)
